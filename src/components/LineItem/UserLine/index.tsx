...
const UserLine: React.FC<UserLineProps> = ({ userId, name, userPanel = true, pic, rank, medal, steps, like, follow, length, onUserClick }) => {
  ...
  return (
    <div className={styles.userItem}>
      <div className={styles.user} onClick={handleOnUserClick}>
